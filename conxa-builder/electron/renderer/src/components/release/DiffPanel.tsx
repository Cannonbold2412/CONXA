...
/** Section 2 — "What Will Change": the deterministic diff between the release
 * candidate and the previous published version. Same shape whether it's a
 * pre-publish preview or a published release's own diff — see release_diff.py. */
