...
Grounding: `current-state.md`, `vs-state-of-the-art.md`, `master-insights.md`. Philosophy constraints from the program brief are enforced (no recommendation puts the LLM in the deterministic hot path).
