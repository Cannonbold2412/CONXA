...
One summary per confirmed paper lives in this folder (`01-external-research/papers/`); the source PDFs are archived separately in the research corpus. For the strategic read on these papers (durability verdicts + one-concept-per-paper), see [`../paper-review.md`](../paper-review.md).
