# CTO Report — Conxa Next-Generation Architecture
...
- **Marketing a differentiator it hasn't built.** The "fingerprint-scored 5-tier AI self-healing cascade" is, in code, a deterministic ladder + *host-delegated manual resume with no write-back* (`current-state.md` §8). Unattended runs don't self-heal. This is the central problem.
