...
- **Source:** Stagehand (self-heal-then-refresh, adapted) + SeeAct (describe-then-match) + browser-use (AX re-ground) + host model via MCP sampling; gap G1; insight C1/#11; `05-recovery.md`.
...
- **Source:** none of the six tools (structurally impossible for single-tenant/local); gap G3; insight L1/#1; `workflow-durability.md`.
...
- **Source:** Playwright (gates incl. stable/RAF) + SeleniumBase (classified ladder); gap G4; insights R2/#4, R3/#8; `runtime.md`.
...
- **Source:** Stagehand + Mind2Web (semantic>structural) + WebArena/WorkArena (golden corpus); gap G7; `workflow-durability.md`.
...
- **Source:** Playwright selectorGenerator + Mind2Web; gap G5; insight #3, C.1 fix; `compiler.md` + `runtime.md`.
...
- **Source:** Impl-Plan Phase 3; gap G8; insight #22 (auditability moat); `enterprise.md`.
...
- **Source:** insight #9/#19, L2; gap G9; `07-skill-pack.md`.
...
- **Source:** insight #15; gap G10; `compiler.md`.
...
- **Source:** WorkArena #24, R1; gap G12; `recording.md`.
...
- **Source:** Playwright MCP (architecture) + insight #5/#20/#17; gap G11; `mcp.md`.
...
- **Source:** Impl-Plan 1.3/1.5/2.x; gap G14; `enterprise.md`.
...
- **Source:** OS-ATLAS + UI-TARS (scaleFactor/SoM) + WebVoyager; gap G13; insight #23; `vision.md`.
