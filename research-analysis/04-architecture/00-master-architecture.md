# Replay System Architecture (Phase 1)
...
The unit of value: a **signed, versioned, entitlement-gated, delta-syncable** package of steps + identity + post-conditions + recovery metadata + conditionals. It is the thing competitors structurally lack (insight #9) and the substrate of the fleet flywheel (insight #1). Full structure in `07-skill-pack.md`.
...
Per step, the universal lifecycle (from `framework.md` §0):
