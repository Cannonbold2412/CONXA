# Enterprise Subsystem — Architecture Design
...
**(b) Durability-repair governance — the novel piece.** The durability flywheel (§6) proposes auto-repairs. **These are governed by the confidence bands from `workflow-durability.md` §3, surfaced as per-customer policy:**
