...
Feeds [`cost_model.md`](../../docs/cost_model.md). TwelveLabs is pay-as-you-go, billed per **minute of video** plus a small token charge on Pegasus text output. Published rates (subject to change; enterprise/Bedrock pricing differs):
